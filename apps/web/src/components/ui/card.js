...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn('rounded-2xl border border-border/60 bg-card/70 text-card-foreground shadow-none', className)} {...props}/>));
