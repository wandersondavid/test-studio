...
environmentRouter.get('/', async (req, res, next) => {
    try {
...
environmentRouter.get('/:id', async (req, res, next) => {
    try {
...
environmentRouter.post('/', async (req, res, next) => {
    try {
...
environmentRouter.put('/:id', async (req, res, next) => {
    try {
...
environmentRouter.delete('/:id', async (req, res, next) => {
    try {
