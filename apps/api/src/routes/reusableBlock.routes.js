...
reusableBlockRouter.get('/', async (_req, res, next) => {
    try {
...
reusableBlockRouter.get('/:id', async (req, res, next) => {
    try {
...
reusableBlockRouter.post('/', async (req, res, next) => {
    try {
...
reusableBlockRouter.put('/:id', async (req, res, next) => {
    try {
...
reusableBlockRouter.delete('/:id', async (req, res, next) => {
    try {
...
//# sourceMappingURL=reusableBlock.routes.js.map