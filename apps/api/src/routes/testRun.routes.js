...
testRunRouter.get('/', requireAuth, async (req, res, next) => {
    try {
...
testRunRouter.get('/:id', requireAuth, async (req, res, next) => {
    try {
...
testRunRouter.get('/:id/steps/:stepId/screenshot', requireAuth, async (req, res, next) => {
    try {
        const item = await runService.findById(req.params.id);
        if (!item) {
...
testRunRouter.post('/execute', requireAuth, async (req, res, next) => {
    try {
...
testRunRouter.post('/execute-suite', requireAuth, async (req, res, next) => {
    try {
...
testRunRouter.patch('/:id/result', requireRunnerSecret, async (req, res, next) => {
    try {
        ...
        res.json(updated);
        const finalStatuses = ['passed', 'failed', 'error'];
