...
testSuiteRouter.get('/', async (req, res, next) => {
    try {
...
testSuiteRouter.get('/:id', async (req, res, next) => {
    try {
...
testSuiteRouter.post('/', async (req, res, next) => {
    try {
...
testSuiteRouter.put('/:id', async (req, res, next) => {
    try {
...
testSuiteRouter.delete('/:id', async (req, res, next) => {
    try {
